 ...
 */
const userSongs =  JSON.parse(localStorage.getItem('songs')) || [];



const addToPlayList = (audioPath,category) =>{

  const search = userSongs.find((x)=> x.path === audioPath);
  ...
  localStorage.setItem("songs",JSON.stringify(userSongs));
